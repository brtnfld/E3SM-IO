...
if [[ "$HOSTNAME_PREFIX" == "cori" ]]; then
    # Cori
    HDF5_SRC_PATH=/global/homes/k/khl7265/hdf5/develop
    ...
    # Summit
    HDF5_SRC_PATH=/gpfs/alpine/csc332/scratch/khl7265/hdf5/develop
    HDF5_LIB_PATH=/gpfs/alpine/csc332/scratch/khl7265/.local/hdf5/develop
    ...
    RTL=1
    PPN=84
    HOSTNAME_PREFIX=summ
elif [[ "$HOSTNAME_PREFIX" == "thet" ]]; then
    # Theta (Not supported yet)
    HDF5_SRC_PATH=/gpfs/mira-home/khou/hdf5/develop
    HDF5_LIB_PATH=/gpfs/mira-home/khou/.local/hdf5/develop
    ...
    # Dev VM
    HDF5_SRC_PATH=${HOME}/Desktop/hdf5/develop
    HDF5_LIB_PATH=${HOME}/.local/hdf5/develop
